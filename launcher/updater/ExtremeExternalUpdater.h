...
class ExtremeExternalUpdater : public ExternalUpdater {
    Q_OBJECT

   public:
    ExtremeExternalUpdater(QWidget* parent, const QString& appDir, const QString& dataDir);
    ~ExtremeExternalUpdater() override;
