...
#define EXTREME_EXTERNAL_EXE
#include "FileSystem.h"

#include "GitHubRelease.h"

class ExtremeUpdaterApp : public QApplication {
    // friends for the purpose of limiting access to deprecated stuff
    Q_OBJECT
   public:
    enum Status { Starting, Failed, Succeeded, Initialized, Aborted };
    ExtremeUpdaterApp(int& argc, char** argv);
    virtual ~ExtremeUpdaterApp();
   ...
   private:
    ...
    bool loadExtremeVersionFromExe(const QString& exe_path);
   ...
   private:
    ...
    QString m_extremeExecutable;
    QUrl m_extremeRepoUrl;
    ...
    QString m_extremeBinaryName;
    QString m_extremeVersion;
    int m_extremeVersionMajor = -1;
    int m_extremeVersionMinor = -1;
    QString m_prsimVersionChannel;
    QString m_extremeGitCommit;
