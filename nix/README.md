...
After adding `github:ExtremeLauncherTeam/ExtremeLauncher` to your flake inputs, you can access the flake's `packages` output.
...
```shell
nix run github:ExtremeLauncherTeam/ExtremeLauncher

nix shell github:ExtremeLauncherTeam/ExtremeLauncher

nix profile install github:ExtremeLauncherTeam/ExtremeLauncher
```
...
{ pkgs, ... }:
{
  environment.systemPackages = [
    (import (
      builtins.fetchTarball "https://github.com/ExtremeLauncherTeam/ExtremeLauncher/archive/develop.tar.gz"
...
```shell
nix-channel --add https://github.com/ExtremeLauncherTeam/ExtremeLauncher/archive/develop.tar.gz extremelauncher
